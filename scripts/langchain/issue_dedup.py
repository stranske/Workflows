...
def format_similar_issues_comment(
    ...
    *,
    ...
    lines += [
        ...
        "",
        "1. **Review the linked issues** to see if they address the same problem",
        "2. **If duplicate:** Close this issue and add your context to the existing one",
        "3. **If different:** Add a comment explaining how this issue is distinct",
        "4. **If related:** Link the issues and keep both open",
        "</details>",
        "",
        "---",
