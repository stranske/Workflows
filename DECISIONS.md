...
## 2026-02-08 - Auth Coverage Artifact (PR #1334 Follow-Up)
Decision: Store the updated auth coverage output in `artifacts/coverage-auth.txt` generated by
...
Rationale: The artifact preserves the exact command and per-file coverage for
