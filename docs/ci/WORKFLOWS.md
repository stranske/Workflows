...
* [`agents-issue-format-guard.yml`](../../.github/workflows/agents-issue-format-guard.yml) validates opened, edited, and reopened issues against `AGENT_ISSUE_FORMAT`; non-conforming work is explicitly dispatched to the optimizer's `format` phase.
