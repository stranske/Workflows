...
- `api.github.com` — [_repos/Workflows/.github/workflows/agents-72-codex-belt-worker.yml](_repos/Workflows/.github/workflows/agents-72-codex-belt-worker.yml#L766)
...
- Shell `gh api` usage (no token-aware retry wrapper) appears in [health-71-sync-health-check.yml](_repos/Workflows/.github/workflows/health-71-sync-health-check.yml#L63), [maint-66-monthly-audit.yml](_repos/Workflows/.github/workflows/maint-66-monthly-audit.yml#L48), [maint-71-auto-fix-integration.yml](_repos/Workflows/.github/workflows/maint-71-auto-fix-integration.yml#L65), [agents-verify-to-new-pr-autopilot.yml](_repos/Workflows/.github/workflows/agents-verify-to-new-pr-autopilot.yml#L26), [health-75-api-rate-diagnostic.yml](_repos/Workflows/.github/workflows/health-75-api-rate-diagnostic.yml#L97), [agents-weekly-metrics.yml](_repos/Workflows/.github/workflows/agents-weekly-metrics.yml#L46), and [reusable-18-autofix.yml](_repos/Workflows/.github/workflows/reusable-18-autofix.yml#L1075).
- Raw `api.github.com` curl usage appears in [reusable-16-agents.yml](_repos/Workflows/.github/workflows/reusable-16-agents.yml#L342) and [agents-72-codex-belt-worker.yml](_repos/Workflows/.github/workflows/agents-72-codex-belt-worker.yml#L766).
...
- Direct `api.github.com` usage without retry wrappers appears in [restore_branch_snapshots.py](_repos/Workflows/.github/scripts/restore_branch_snapshots.py#L69).
