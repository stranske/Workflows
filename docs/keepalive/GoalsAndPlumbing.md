...
- After repeated failures (default: 3), the loop pauses the current strategy and dispatches one non-recursive forced recovery lease. After that forced run, the hourly keepalive sweep owns the next recovery review.
