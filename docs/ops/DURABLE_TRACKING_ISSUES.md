...
| [#2210](https://github.com/stranske/Workflows/issues/2210) | 🔄 Consumer repo drift detected | [`health-68-consumer-sync-drift.yml`](../../.github/workflows/health-68-consumer-sync-drift.yml) | After each `Merge Sync PRs` run, on qualifying template/script pushes, or manual dispatch | Body rewritten in place, but only for actionable states |
