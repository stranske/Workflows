...
`delivery_contract_blocked` with the expected and observed plan IDs and routes back
to the owning plan. Stale-PR cleanup is likewise restricted to the selected plan.
