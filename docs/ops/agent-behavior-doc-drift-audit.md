...
| `docs/ci/WORKFLOWS.md` | Verifier docs say maintainers or follow-up automation can apply `verify:create-new-pr`. | `agents-verify-to-new-pr.yml` label trigger. | `already-correct` | No change. |
