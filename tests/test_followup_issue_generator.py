...
class TestGenerateFollowupIssue:
    ...
    def test_select_followup_acceptance_criteria_keeps_workflow_items_when_not_repo_local(
        self,
    ):
        acceptance = [
            "The follow-up PR does not add or modify Workflows-owned scripts in Pension-Data",
    ...
    def test_select_followup_acceptance_criteria_filters_workflow_items_by_acceptance_mix(
        self,
    ):
        acceptance = [
            "The follow-up PR does not add or modify Workflows-owned scripts in Pension-Data",
    ...
    def test_build_why_section_emphasizes_repo_local_summary_for_mixed_surface(self):
