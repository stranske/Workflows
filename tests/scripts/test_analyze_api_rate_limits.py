...
def test_summarize_workflow_activity_splits_mixed_delimiters(monkeypatch) -> None:
    calls: list[str] = []
...
def test_summarize_workflow_activity_normalizes_git_remote_outputs(monkeypatch) -> None:
    ...
    summaries = analyze_api_rate_limits.summarize_workflow_activity(
        [
            "git@github.com:owner/repo.git (fetch)",
            "https://github.com/owner/repo.git (push)",
...
def test_summarize_workflow_activity_strips_wrapping_punctuation(monkeypatch) -> None:
    calls: list[str] = []
...
def test_summarize_workflow_activity_strips_repo_refs(monkeypatch) -> None:
    calls: list[str] = []
